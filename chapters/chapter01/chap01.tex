...
\initial{T}his chapter will serve as a contextual guide for the document. It introduces the project background to outline the aims, objectives and overall structure of the document. The chapter concludes by explaining the key areas of the project, structured as per the scope.
