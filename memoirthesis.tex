...
\usepackage{datetime}
\usepackage{ifpdf}
\usepackage[export]{adjustbox} %For justifying or alligning images
\usepackage{textcomp} %For apostrophe
\usepackage{dirtytalk}%API: say{} to quote. That is it.
...
% frontmatter. This will work for title, ExecutiveSummary and declaration. Though the
...
\usepackage[swedish,english]{babel}		%For languages characters and hyphenation
...
% Preliminary pages
% 
% The five preliminary pages must be the Title Page, ExecutiveSummary, Dedication
...
\clearemptydoublepage
%
\input{frontmatter/ExecutiveSummary}
\clearemptydoublepage
%
